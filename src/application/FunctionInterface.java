...
public class FunctionInterface {
    ...
    private static void beforeJava8() {
        ...
        double realValue = convertDolarToReal(dolarAmount);
        System.out.println("From beforeJava8: " + dolarAmount + " dolares = " + realValue + " reais");
    }
    ...
    private static void afterJava8() {
        ...
        Function<Integer, Double> function = realValue -> dolarAmount * realRate;
